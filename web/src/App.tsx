...
function App() {
    ...
    const handleModuleRotated = (id: string) => {
        setPlacedModules((prev) => prev.map((module) => (module.id === id ? { ...module, rotation: (module.rotation + 90) % 360 } : module)));
    };
                    ...
                    <div className="flex-1 flex items-stretch">
                        ...
                        <aside className="w-80 max-w-xs border-l border-border bg-card/90 h-full flex flex-col overflow-y-auto sticky top-0 shadow-md px-4 py-6">
                            ...
                            <ScrollArea className="h-[200px]">
                                <ModuleLibrary modules={filteredModules} onModulePlaced={handleModulePlaced} />
                            </ScrollArea>
                        </aside>
                    </div>
                </main>
